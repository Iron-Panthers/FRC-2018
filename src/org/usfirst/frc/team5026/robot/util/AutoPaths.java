...
public class AutoPaths {
	...
	private static double[][] RIGHT_SCALE_LEFT_START = new double[][]{
		...
		{282.7232876712329, 70.87293956043956},
	};
	...
	public static FastPathPlanner[] getLeftSwitch2Cube() {
		if (CENTER_LEFT_SWITCH_2_CUBE == null) {
			double[][] leftReturnCube = new double[][]{
				...
				{112.29041095890412, 221.53365384615384},
				{125.60547945205481, 221.97939560439562},
			};
	...
	public static FastPathPlanner[] getLeftStartingLeftScale2Cube() {
		if (LEFT_START_LEFT_SCALE_2 == null) {
			...
			double[][] leftScaleBackup = new double[][]{
				...
				{232.56986301369867, 288.3949175824176},
				{224.58082191780824, 295.5267857142857},
			};
			...
			double[][] leftScaleGrabCube = new double[][]{
				...
				{230.79452054794524, 252.73557692307693},
				{225.46849315068496, 242.03777472527474},
			};
			
			double[][] leftScaleReturnCube = new double[][]{
				{291.15616438356165, 258.08447802197804},
				{279.6164383561644, 260.75892857142856},
				{261.86301369863014, 269.67376373626377},
				{241.44657534246576, 280.3715659340659},
				{229.9068493150685, 289.2864010989011},
				{226.35616438356166, 293.7438186813187},
			};
