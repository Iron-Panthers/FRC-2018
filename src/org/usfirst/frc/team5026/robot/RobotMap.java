...
public class RobotMap {
	...
	public static final int SLAVE_PORT = 3;
...
//	public static final int LIMIT_SWTICH_F = 1; // Subject to change
//	public static final int LIMIT_SWTICH_R = 1; // Subject to change
