...
public class LeftSwitch2Cube extends CommandGroup {
    ...
    public LeftSwitch2Cube() {
        addSequential(new PathFollower(AutoPaths.getLeft2Cube()[0]));
        addSequential(new ConveyorForTime(false, 0.5));
        addParallel(new ElevatorExtendPistons());
        addSequential(new PathFollower(AutoPaths.getLeft2Cube()[1]));
        addParallel(new ElevatorTarget(0));
        addParallel(new IntakeCommand());
        addSequential(new PathFollower(AutoPaths.getLeft2Cube()[2]));
        addParallel(new IntakeCommandGroup());
        addSequential(new PathFollower(AutoPaths.getLeft2Cube()[3]));
        addSequential(new PathFollower(AutoPaths.getLeft2Cube()[4]));
