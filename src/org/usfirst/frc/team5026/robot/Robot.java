...
//		hardware.elevatorMotor.set(ControlMode.MotionMagic, Constants.TICK_TARGET);
		hardware.elevatorMotor.set(ControlMode.PercentOutput, oi.stick.getY());
		SmartDashboard.putNumber("Encoder Position", hardware.elevatorMotor.getSelectedSensorPosition(0));
		SmartDashboard.putNumber("Talon Speed", hardware.elevatorMotor.getMotorOutputPercent());
//		System.out.println(talon.getMotorOutputPercent());
		Scheduler.getInstance().run();
	}
